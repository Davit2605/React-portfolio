...
export default function App() {
  ...
  const testimonials = [
    ...
    {
      quote:
        "Quick, clean, and very professional. Im delighted! — Fionnuala Kelly",
      author: "— Fionnuala K. ",
    },
  ];
        ...
        <section id="services" className="services container">
          ...
          <div className="cards">
            ...
            <article className="card">
              ...
              <p>
                Cabinet refinishing, decorative finishes, murals, epoxy floors
        ...
        <section id="contact" className="contact container">
          ...
          <div className="contact-grid">
            <div className="contact-info">
              ...
              <p>
                Phone: <a href="tel:+353-873498258">+353-873498258</a>
              </p>
              <p>
                Email:{" "}
            ...
            <form className="contact-form" onSubmit={handleSubmit}>
              ...
              <div className="form-row">
                ...
                <a className="btn btn-outline" href="tel:+353-873498258">
                  Call Us
                </a>
              </div>
            </form>
